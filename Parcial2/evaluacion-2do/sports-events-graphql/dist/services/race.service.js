...
let RaceService = class RaceService {
    ...
    async createRace(createRaceInput) {
        ...
        const race = new race_entity_1.Race(Object.assign(Object.assign({ id: (0, uuid_1.v4)() }, createRaceInput), { status: createRaceInput.status || race_entity_1.RaceStatus.PLANNED, createdAt: new Date(), updatedAt: new Date() }));
    ...
    async updateRace(id, updateRaceInput) {
        ...
        const updatedRace = this.persistence.update('races', id, updateRaceInput);
        if (!updatedRace) {
            throw new common_1.NotFoundException(`Carrera con ID ${id} no encontrada`);
        }
        return updatedRace;
